...
// @ts-nocheck 
/*
 * This file exports the `OfferComponent` model and its related types.
 *
...
export type GetOfferComponentAggregateType<T extends OfferComponentAggregateArgs> = {
      [P in keyof T & keyof AggregateOfferComponent]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateOfferComponent[P]>
    : Prisma.GetScalarType<T[P], AggregateOfferComponent[P]>
}
...
export type GetOfferComponentGroupByPayload<T extends OfferComponentGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<OfferComponentGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof OfferComponentGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], OfferComponentGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], OfferComponentGroupByOutputType[P]>
      }
    >
  >
...
export type OfferComponentCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<OfferComponentFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface OfferComponentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['OfferComponent'], meta: { name: 'OfferComponent' } }
  /**
   ...
   * })
  **/
  count<T extends OfferComponentCountArgs>(
    args?: Prisma.Subset<T, OfferComponentCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], OfferComponentCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends OfferComponentGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, OfferComponentGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetOfferComponentGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
