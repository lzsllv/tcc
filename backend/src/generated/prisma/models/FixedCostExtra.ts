...
// @ts-nocheck 
/*
 * This file exports the `FixedCostExtra` model and its related types.
 *
...
export type GetFixedCostExtraAggregateType<T extends FixedCostExtraAggregateArgs> = {
      [P in keyof T & keyof AggregateFixedCostExtra]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateFixedCostExtra[P]>
    : Prisma.GetScalarType<T[P], AggregateFixedCostExtra[P]>
}
...
export type GetFixedCostExtraGroupByPayload<T extends FixedCostExtraGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<FixedCostExtraGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof FixedCostExtraGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], FixedCostExtraGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], FixedCostExtraGroupByOutputType[P]>
      }
    >
  >
...
export type FixedCostExtraCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<FixedCostExtraFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface FixedCostExtraDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['FixedCostExtra'], meta: { name: 'FixedCostExtra' } }
  /**
   ...
   * })
  **/
  count<T extends FixedCostExtraCountArgs>(
    args?: Prisma.Subset<T, FixedCostExtraCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], FixedCostExtraCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends FixedCostExtraGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, FixedCostExtraGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFixedCostExtraGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
