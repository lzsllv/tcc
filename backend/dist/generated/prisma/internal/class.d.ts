 ...
 * `prisma.workspace`: Exposes CRUD operations for the **Workspace** model.
  ...
  */
    ...
    /**
     * `prisma.fixedCosts`: Exposes CRUD operations for the **FixedCosts** model.
      * Example usage:
      * ```ts
      ...
      * ```
      */
    get fixedCosts(): Prisma.FixedCostsDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.fixedCostExtra`: Exposes CRUD operations for the **FixedCostExtra** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more FixedCostExtras
      * const fixedCostExtras = await prisma.fixedCostExtra.findMany()
      * ```
      */
    get fixedCostExtra(): Prisma.FixedCostExtraDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
    ...
    /**
     * `prisma.offerComponent`: Exposes CRUD operations for the **OfferComponent** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more OfferComponents
      * const offerComponents = await prisma.offerComponent.findMany()
      * ```
      */
    get offerComponent(): Prisma.OfferComponentDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.salesChannel`: Exposes CRUD operations for the **SalesChannel** model.
      ...
      * ```
      */
    get salesChannel(): Prisma.SalesChannelDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.channelFee`: Exposes CRUD operations for the **ChannelFee** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more ChannelFees
      * const channelFees = await prisma.channelFee.findMany()
      * ```
      */
    get channelFee(): Prisma.ChannelFeeDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
}
