...
const workspaceSchema = z.object({
    ...
    for (const [offerIndex, offer] of workspace.offers.entries()) {
        const componentIngredients = new Set();
...
export function parseWorkspace(input, authenticatedOwnerId) {
...
export function createEmptyWorkspace(ownerId, now = new Date().toISOString()) {
